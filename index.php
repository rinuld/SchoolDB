        ...
        <div id="main" class="bg-no-repeat bg-left w-full h-screen bg-fixed bg-cover" style="background-image: url('views/assets/images/college.jpg');">
            ...
            <nav class="fixed flex flex-col items-center justify-between py-5 w-full md:flex-row px-4 shadow-lg z-40 bg-indigo-600">
                <div class="relative flex flex-col md:flex-row">
                    <a href="#main" class="flex items-center mb-5 font-medium text-gray-900 lg:w-auto md:mb-0">
                    ...
                    <div class="flex flex-wrap items-center mb-5 md:mb-0 md:border-l md:border-white md:mx-3">
                        <a href="#_" class="mx-3 font-medium text-white hover:text-indigo-100">Student</a>
                        <a href="#_" class="mr-3 font-medium text-white hover:text-indigo-100 s:mx-3">Course</a>
                        <a href="#records" class="mr-3 font-medium text-white hover:text-indigo-100 s:mx-3">Records</a>
                    </div>
                </div>
            </nav>
            ...
            <div class="bg-white w-full h-screen bg-opacity-75">
                ...
                <section id="records" class="py-48">
                    <div class="max-w-6xl mx-auto">
                        ...
                        <div class="grid grid-cols-2 gap-8 mt-10 sm:grid-cols-2 lg:grid-cols-2 sm:px-8 xl:px-0 lg:flex">
                            ...
                            <div class="transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300 flex flex-col items-center col-span-4 px-8 py-12 bg-gray-600 text-white rounded-md md:w-full">
                                ...
                                <h4 class="text-xl font-medium my-2">Student</h4>
                                <p class="text-center">Records of the students enrolled in our courses.</p>
                            </div>
                            ...
                            <div class="transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300 flex flex-col items-center col-span-4 px-8 py-12 bg-gray-600 text-white rounded-md md:w-full">
                                ...
                                <h4 class="text-xl font-medium my-2">Course</h4>
                                <p class="text-center">A list of our available courses.</p>
                            </div>
