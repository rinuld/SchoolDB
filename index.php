                ...
                <section id="records" class="py-48">
                    <div class="max-w-6xl mx-auto">
                        ...
                        <div class="grid grid-cols-2 gap-8 mt-10 sm:grid-cols-2 lg:grid-cols-2 sm:px-8 xl:px-0 lg:flex">
                            ...
                            <div class="flex flex-col items-center col-span-4 px-8 py-12 bg-gray-600 text-white rounded-md">
                                ...
                                <p class="text-center">Send out notifications to all your customers to keep them engaged.</p>
                            </div>
