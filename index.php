                    ...
                    <div class="items-center max-w-6xl px-8 mx-auto">
                        <div class="flex flex-wrap items-center sm:-mx-3">
                            ...
                            <div class="w-full md:w-1/2 md:px-3">
                                <div class="w-full text-white pb-6 space-y-6 sm:max-w-md lg:max-w-lg md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0">
                                    <h1 class="text-4xl font-extrabold sm:text-5xl md:text-4xl lg:text-5xl xl:text-6xl">
                                        <span class="block xl:inline">Welcome to</span>
                                        <span class="block text-indigo-600 xl:inline">SchoolDB!</span>
                                    </h1>
                                    <p class="mx-auto font-bold sm:max-w-md lg:text-xl md:max-w-3xl">
                    ...
                    <div class="max-w-6xl mx-auto">
                        <div class="flex flex-col items-center">
                            ...
                            <div class="flex flex-row items-center">
                                ...
                                <button id="hideTable" class="mt-10 mx-2 focus:outline-none transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300 bg-gray-600 rounded-full hidden" onclick="hideTable()">
                        ...
                        <div class="grid grid-cols-2 gap-8 mt-10 sm:grid-cols-2 lg:grid-cols-2 sm:px-8 xl:px-0 lg:flex">
                            <button id="table1" class="focus:outline-none transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300 flex flex-col items-center col-span-4 px-8 py-12 bg-gray-600 rounded-md md:w-full" onclick="showStudent()">
                            ...
                            <button id="table2" class="focus:outline-none transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300 flex flex-col items-center col-span-4 px-8 py-12 bg-gray-600 rounded-md md:w-full" onclick="showCourse()">
                                <div class="p-1 bg-indigo-600 rounded-full">
